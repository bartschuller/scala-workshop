...
font.setAttribute("src", "s5/ui/graphic_support/numeric.png");
signs = {
...
function notOperaFix() {
	...
	if ((isIE && notIE7) && document.styleSheets && document.styleSheets[0]) {
		document.styleSheets[0].addRule('img', 'behavior: url(s5/ui/graphic_support/iepngfix.htc)');
		document.styleSheets[0].addRule('div', 'behavior: url(s5/ui/graphic_support/iepngfix.htc)');
		document.styleSheets[0].addRule('.slide', 'behavior: url(s5/ui/graphic_support/iepngfix.htc)');
	}
}
...
function createProgress() {
	...
	pg.style.backgroundImage="url(s5/ui/graphic_support/progress.gif)";
	document.getElementsByTagName("body")[0].insertBefore(pg,obj);

	var im = document.createElement('img');
	im.id = "StartupControl";
	im.src = "s5/ui/graphic_support/blank.gif?" + new Date().valueOf();
...
function byby() {
	...
	if(tranSitions && fadeModus && s5mode && !isOp) {
		...
		pg.style.backgroundPosition="center center";
		pg.style.backgroundRepeat="no-repeat";
		pg.style.backgroundImage="url(s5/ui/graphic_support/finish.gif)";		
...
function createHelpReq() {
	if(!document.getElementById("HelpReq")) {
		...
		pg.style.backgroundPosition="center center";
		pg.style.backgroundRepeat="no-repeat";
		pg.style.backgroundImage="url(s5/ui/graphic_support/help.jpg)";
		document.getElementsByTagName("body")[0].insertBefore(pg,obj);
		if(document.getElementById("HelpReq")) {
			helpmode = true;
		}
...
if(!isIE && !isOp) {
	document.write('<script type="text/javascript" src="s5/ui/audio_support/soundmanager2.js"></script>');
	if(typeof soundManager!="undefined") {
		var allMetas = document.getElementsByTagName('meta');
		for (var i = 0; i< allMetas.length; i++) {
